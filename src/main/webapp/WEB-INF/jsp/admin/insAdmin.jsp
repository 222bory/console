...
$(document).ready(function(){
	$("#btnCancel").click(function(){
	 ...
	 $('#frm').validate({
	     rules: {
	       ...
	       upw :{required : true, minlength: 4, maxlength:100},
	       upwConfirm : {required : true, minlength: 4, equalTo:"#upw", maxlength:100},
	     ...
	     messages:{
	    	...
	    	upw:{required :"패스워드를 입력해주세요",
	    		minlength :"패스워드는 최소 4자리 이상 입력해주세요"},
	    	upwConfirm:{
	...
	function redirectList(){
		//$("#frm").attr("action", "/selectListAdmin");
					...
					<div class="card-body">
						<form class="form-horizontal" id="frm" name="frm" method="POST" >
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="password" class="form-control form-control-sm" id="upw" name="upw" >
								</div>
							</div>
							<div class="line"></div>
							<div class="form-group">
								...
								<div class="col-md-5">
									<input type="password" class="form-control form-control-sm" id="upwConfirm" name="upwConfirm" >
								</div>
							</div>
							<div class="line"></div>
							<div class="form-group">
